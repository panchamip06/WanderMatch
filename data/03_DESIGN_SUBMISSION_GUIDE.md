...
3. `data/queries/starter_queries.sql` — run them against `data/PS-11.db`. Ten minutes of running real queries will change what you design.
...
```
<TeamName>_PS-11_Design_v1.pdf
<TeamName>_PS-11_Wireframes.pdf
<TeamName>_PS-11_Architecture.drawio
```
...
3. Confirm the problem statement shown is PS-11. If it is not, stop and contact the organisers — do not upload.
