...
**27,428 rows across 14 tables**, of which 13 are the tables your
...
Or open `data/PS-11.db` in any SQLite client. Nothing to install, nothing to import.
...
In `PS-11.db` the money columns are declared `TEXT`. That is deliberate: SQLite's NUMERIC
...
```bash
python3 tools/validate_conformance.py data/PS-11.db     # or point it at your own export
```
